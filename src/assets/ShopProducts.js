...
export const ShopProducts = [
    ...
    },
    {
        ...
        description: "A timeless silver chronograph watch featuring a genuine dark brown leather strap, three sub-dials, and elegant black face.",
        price: 4999,
        image: [assets.watch_classic],
        category: "Accessories",
        subCategory: "Watches",
        sizes: ["Regular"],
        date: 1716668445452,
    ...
    },
    {
        ...
        description: "Handcrafted formal leather Oxford shoes with a polished brown finish, perfect for weddings, business meetings, and black-tie events.",
        price: 3499,
        image: [assets.shoes_formal],
        category: "Accessories",
        subCategory: "Shoes",
        sizes: ["7", "8", "9", "10"],
        date: 1716668445453,
    ...
    {
        _id: "aaacm",
        name: "Suede Leather Slip-On Loafers",
        description: "Classy and extremely comfortable suede slip-on loafers, excellent for smart-casual weekends and evening gatherings.",
        price: 2799,
        image: [assets.shoes_casual],
        category: "Accessories",
        subCategory: "Shoes",
        sizes: ["7", "8", "9", "10"],
        date: 1716668445454,
    ...
    },
    {
        ...
        description: "Retro-style lightweight sneakers with a cushioned sole and breathable knit mesh, built for daily commutes and active days.",
        price: 1999,
        image: [assets.shoes_sneaker],
        category: "Accessories",
        subCategory: "Shoes",
        sizes: ["7", "8", "9", "10"],
        date: 1716668445455,
    ...
    {
        _id: "aaaco",
        name: "Elegant Rose Gold Women's Watch",
        description: "A delicate, minimalist rose gold watch with a premium mesh strap, adding a touch of feminine sophistication to any outfit.",
        price: 3999,
        image: [assets.girl_watch],
        category: "Accessories",
        subCategory: "Watches",
        sizes: ["Regular"],
        date: 1716668445456,
    ...
    {
        _id: "aaacp",
        name: "Sparkling Pearl Drop Earrings",
        description: "Exquisite drop earrings featuring freshwater pearls suspended from sterling silver, perfect for elegant formal events and daily luxury.",
        price: 1299,
        image: [assets.girl_earrings],
        category: "Accessories",
